...
|-------|-------|------|--------|---------|
| `heading-lg` | Section titles (cards, panels) | 18px (text-lg) | Bold (font-bold) | "Today's Classes", "Mark Attendance" |
...
### Dashboard Page
- **Section Heading**: `heading-lg` (18px, bold) - "Today's Classes", "Mark Attendance"
...
## Components Updated (Jan 20, 2026)
- ✅ StatCard
- ✅ TodayClasses  
- ✅ PerformanceChart
- ✅ AlertsNotifications
