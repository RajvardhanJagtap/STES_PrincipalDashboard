  ...
  exams: [
    {
      ...
      duration: '2 hours',
      totalMarks: 100,
      topicsCovered: ['Arrays & Linked Lists', 'Stacks & Queues', 'Trees & Graphs'],
    ...
    },
    {
      ...
      duration: '2.5 hours',
      totalMarks: 100,
      topicsCovered: ['Dynamic Programming', 'Graph Algorithms', 'Greedy & NP-Completeness'],
      instructions: 'Carry student ID and admit card. No electronic devices allowed.',
      enrolledStudents: 38,
    },
    {
      id: 'exam-3',
  ...
  classes: [
    {
      ...
      students: [
        { id: 's1', name: 'Sarah Johnson', rollNumber: 'CS001', initials: 'SJ' },
        ...
        { id: 's5', name: 'Lisa Anderson', rollNumber: 'CS005', initials: 'LA' },
    ...
    },
    {
      ...
      students: [
        ...
        { id: 's24', name: 'Siddharth Roy', rollNumber: 'WD006', initials: 'SR' },
      ],
    },
  ],
};
